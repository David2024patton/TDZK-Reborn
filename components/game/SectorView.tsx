...
import { GOODS, SHIPS, WEAPONS, DRONES, UPGRADES, EQUIPMENT, ITEMS } from '../../data/helpData';
...
const SectorEntity: React.FC<{ name: string, sub?: string, align?: string | number, level?: string | number, onRaid?: () => void, onDock?: () => void }> = ({ name, sub, align = "0", level = "5", onRaid, onDock }) => (
...
const StationInnerEntity: React.FC<{ name: string, onUndock?: () => void }> = ({ name, onUndock }) => {
...
const PlanetInnerEntity: React.FC<{ planet: any, messages: { public: string, internal: string }, onUndock: () => void, onUpdateMessages: (p: string, i: string) => void }> = ({ planet, messages, onUndock, onUpdateMessages }) => {
...
const PlanetEntity: React.FC<{ name: string, ownerName: string, allianceName?: string, rating: string, population: string, alignment: string, relationship?: string, onAttack?: () => void, onLand?: () => void }> = ({
