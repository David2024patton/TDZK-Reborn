...
export const DPad: React.FC<DPadProps> = ({ className = '' }) => {
  return (
    <div className={`relative w-[100px] h-[100px] flex items-center justify-center ${className}`}>
      ...
      {/* Center (Sector) */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-10 h-10 bg-black border border-[#0066cc] flex items-center justify-center z-20 shadow-[0_0_15px_rgba(0,100,255,0.3)] rounded-sm active:scale-95 transition-transform cursor-pointer hover:bg-[#001133]">
